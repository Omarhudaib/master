                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                                <div class="pl-4 p-3">
                                    ...
                                    @if($employeeId)
                                        <a href="{{ route('employeeshda.edit', $employeeId) }}" class="btn btn-warning btn-sm">Edit Employee</a>
                                        <a href="{{ route('chatda.show', $employeeId) }}" class="btn btn-info btn-sm">Chat</a>
                                    @else
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('employeesda') }}" aria-expanded="false">
                                <i class="fas fa-child"></i>
                                <span class="hide-menu">Employees</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('teamsda.index') }}" aria-expanded="false">
                                <i class="icon-people"></i>
                                <span class="hide-menu">Teams</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('projectsda.index') }}" aria-expanded="false">
                                <i class="icon-briefcase"></i>
                                <span class="hide-menu">Projects</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('departmentsda.index') }}" aria-expanded="false">
                                <i class="icon-docs"></i>
                                <span class="hide-menu">Departments</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('tasksda.index') }}" aria-expanded="false">
                                <i class="fas fa-tasks"></i> <!-- Icon for Tasks -->
                                <span class="hide-menu">Tasks</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('requestsda.index') }}" aria-expanded="false">
                                <i class="fas fa-paper-plane"></i> <!-- Icon for Requests -->
                                <span class="hide-menu">Requests</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('meetingsda.index') }}" aria-expanded="false">
                                <i class="fas fa-calendar-alt"></i> <!-- Icon for Meetings -->
                                <span class="hide-menu">Meetings</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('positionsda.index') }}" aria-expanded="false">
                                <i class="fas fa-briefcase"></i> <!-- Icon for Positions -->
                                <span class="hide-menu">Positions</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('ticketsda.index') }}" aria-expanded="false">
                                <i class="fas fa-briefcase"></i> <!-- Icon for Positions -->
                                <span class="hide-menu">Tickets</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('reportda') }}" aria-expanded="false">
                                <i class="fas fa-briefcase"></i> <!-- Icon for Positions -->
                                <span class="hide-menu">Salary Report</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('chatda.index', ['employeeId' => auth()->user()->employee->id]) }}" aria-expanded="false">
                                <i class="fas fa-briefcase"></i> <!-- Icon for Positions -->
