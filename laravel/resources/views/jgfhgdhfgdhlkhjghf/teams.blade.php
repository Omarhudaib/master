        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card shadow-sm mb-4">
                    ...
                    <div class="card-body">
                        <a href="{{ route('teamsda.create') }}" class="btn btn-info mb-3">Add Team</a>
                    </div>
                </div>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Add Employee Form -->
                                            <form action="{{ route('teamsda.addEmployees') }}" method="POST">
                                                @csrf
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('teamsda.destroy', $team->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
