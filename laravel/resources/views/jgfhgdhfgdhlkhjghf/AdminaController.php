...
class AdminaController extends Controller
{
    ...
    public function indexDepartment()
    {
        ...
        return view('admina.department', compact('departments'));
    }
    ...
    public function index()
{
 ...
 $employeeId = auth()->user()->employee->id;
    ...
    return view('admina.home_admin', compact('latestCheckIn', 'canCheckIn', 'canCheckOut','employees', 'tasks','teams', 'departments', 'positions', 'leaveRequests', 'dailyInOuts'));
}
...
public function showall()
{
    ...
    return view('admina.employees', compact('employees', 'roles', 'departments', 'positions', 'teams'));
}
...
public function showemployee()
{
    ...
    return view('admina.employees_add', compact('employees', 'users', 'roles', 'departments', 'positions', 'teams'));
}
...
public function store(Request $request)
{
    ...
    return redirect()->route('employeesda')->with('success', 'Employee created successfully.');
}
    ...
    public function edit($id)
    {
        ...
        return view('admina.employees_edit', compact('employee', 'user', 'roles', 'departments', 'positions', 'teams'));
    }

public function show($id)
{
    $employee = Employee::with(['user.role', 'department', 'position', 'teams'])->findOrFail($id);
    return view('admina.employees_show', compact('employee'));
}
public function update(Request $request, $id)
{
    ...
    return redirect()->route('employeesda')->with('success', 'Employee updated successfully.');
}
...
public function destroy($id)
{
    ...
    return redirect()->route('employeesda')->with('success', 'Employee deleted successfully');
}
...
public function storeproject(Request $request)
{
    ...
    return redirect()->route('projectsda.index')->with('success', 'Project created successfully.');
}
...
public function indexproject()
{
    ...
    return view('admina.projects', compact('projects'));
}
...
public function editproject($id)
{
    ...
    return view('admina.projects_edit', compact('project', 'teams'));
}
public function createproject()
{
    $teams = Team::all(); // Assuming you have a Team model to fetch all teams
    return view('admina.projects_create', compact('teams'));
}
...
public function destroyproject($id)
{
    $project = Project::findOrFail($id);
    $project->delete();
    return redirect()->route('projectsda.index')->with('success', 'Project deleted successfully.');
}
...
public function indexteams()
{
    ...
    return view('admina.teams', compact('teams', 'availableEmployees'));
}
...
public function createteams()
{
    ...
    return view('admina.teams_create', compact('employees'));
}
...
public function storeteams(Request $request)
{
    ...
    return redirect()->route('teamsda.index')->with('success', 'Team created successfully.');
}

public function showteams(Team $team)
{
    $availableEmployees = Employee::all(); // Assuming this is how you get the available employees
    return view('admina.teams_show', compact('team', 'availableEmployees'));
}

public function editteams(Team $team)
{
    $employees = Employee::all();
    return view('admina.teams_edit', compact('team', 'employees'));
}
...
public function updateteams(Request $request, Team $team)
{
    ...
    return redirect()->route('teamsda.index')->with('success', 'Team updated successfully.');
}

public function destroyteams(Team $team)
{
    $team->delete();
    return redirect()->route('teamsda.index')->with('success', 'Team deleted successfully.');
}
...
public function listTasks()
{
    ...
    return view('admina.task', compact('tasks'));
}
    ...
    public function fetchEmployees($projectId)
        ...
        public function showCreateForm()
        {
            ...
            $employees = Employee::all();
            return view('admina.task_create', compact('teams', 'projects', 'employees'));
        }
        ...
        public function storeTask(Request $request)
        {
            ...
            return redirect()->route('tasksda.index')->with('success', 'Task created successfully.');
        }

        public function showTask(Task $task)
        {
            return view('admina.task_show', compact('task'));
        }
        ...
        public function showEditForm(Task $task)
        {
            ...
            $projects = Project::all();
            $employees = Employee::all();
            return view('admina.task_edit', compact('task', 'teams', 'projects', 'employees'));
        }
        ...
        public function updateTask(Request $request, Task $task)
        {
            ...
            return redirect()->route('tasksda.index')->with('success', 'Task updated successfully.');
        }
        ...
        {
            $task->delete();
            return redirect()->route('tasksda.index')->with('success', 'Task deleted successfully.');
        }
        ...
        public function indexMeeting()
{
    ...
    return view('admin.meetings', compact('meetings'));
        ...
        public function createMeeting()
        {
            ...
            return view('admina.meetings_add', compact('employees'));
        }
        ...
        public function storeMeeting(Request $request)
        {
            ...
            return redirect()->route('meetingsda.index');
        }
        public function editMeeting($id)
        {
            ...
            return view('admina.meetings_edit', compact('meeting', 'employees'));
        }


        public function showMeeting(Meeting $meeting)
        {
            return view('admina.meetings_show', compact('meeting'));
        }
        ...
        public function showRelations($employeeId)
        {
            ...
            return view('admina.relations', compact('employee', 'allEmployees'));
        }
...
public function indexm($employeeId)
{
    ...
    ->get()
    ->reverse();
    return view('admina.chat', compact('employee', 'employees', 'messages'));
}
...
public function indexPosition()
{
    ...
    return view('admina.positions', compact('positions'));
}
...
{
    $departments = Department::all();
    return view('admina.positions_create', compact('departments'));
}
...
{
    return view('admina.positions_show', compact('position'));
}
...
{
    $departments = Department::all();
    return view('admina.positions_edit', compact('position', 'departments'));
}
...
public function indexTicket()
{
    ...
    return view('admina.tickets', compact('tickets'));
}

public function createTicket()
{
    $employees = Employee::all();
    return view('admina.tickets_create', compact('employees'));
}
...
{
    $employees = Employee::all();
    return view('admina.tickets_edit', compact('ticket', 'employees'));
}
...
public function report()
{
    ...
    return view('admina.reports', compact('monthlyData'));
}
...
public function indexreq()
{
    ...
    return view('admina.requests', compact('requests'));
}
