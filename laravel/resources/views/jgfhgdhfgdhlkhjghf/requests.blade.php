                    ...
                    <table class="table table-bordered shadow">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('requestsda.updateStatus', $request->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                ...
                                <td>
                                    <form action="{{ route('requestsda.destroy', $request->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
