                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $request->employee->sick_leaves - ($request->status == 'Approved' ? $request->leave_days : 0) }}</td>
                                    <td>{{ $request->employee->annual_vacation_days - ($request->status == 'Approved' ? $request->vacation_days : 0) }}</td>
                                    <td>
                                        @if($request->path)
                                        <a href="{{ asset('storage/' . $request->path) }}" target="_blank" class="btn btn-sm btn-info">View File</a>
                                        @else
                                            N/A
                                        @endif
                                    </td>
